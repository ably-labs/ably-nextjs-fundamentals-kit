  ...
  return (
    <div className="flex flex-row justify-start items-start gap-6 pt-12 pr-12 pb-12 pl-12 w-[1280px] h-[960px] bg-white">
      <div className="flex flex-row justify-start items-start gap-4 w-[1184px]">
          ...
          <div className="flex flex-row justify-start items-center gap-6 w-[264px]">
            <img
              width="96px"
              height="96px"
              ...
              <div className="flex flex-col justify-start items-start pt-6 pr-6 pb-6 pl-6 rounded-2xl h-[216px] bg-white">
                <div className="flex flex-col justify-center items-start gap-4 h-[168px]">
                  <div className="flex flex-row justify-start items-center gap-4 w-80">
                    <div className="flex flex-row justify-center items-center pt-3 pr-3 pb-3 pl-3 rounded-lg h-14 bg-gradient-to-br from-[rgba(255,255,255,1)] from-29% to-[rgba(248,250,252,1)] to-134%">

export default function SampleHeader(props: { sampleName:string, sampleIcon:string, sampleDocsLink:string }) {
  return (
    <div className="flex flex-row justify-between items-center gap-6 w-[752px] h-16">
      <div className="flex flex-row justify-start items-center gap-6 w-[480px]">
        <div className="flex flex-row justify-center items-center pt-3 pr-3 pb-3 pl-3 rounded-xl h-16 bg-gradient-to-br from-[rgba(255,255,255,1)] from-29% to-[rgba(248,250,252,1)] to-134%">
